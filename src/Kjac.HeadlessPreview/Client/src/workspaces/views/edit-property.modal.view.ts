...
export const HEADLESS_PREVIEW_EDIT_PROPERTY_MODAL_TOKEN = new UmbModalToken<EditPropertyModalData, EditPropertyModalValue>(
...
@customElement('headless-preview-edit-property-modal-view')
